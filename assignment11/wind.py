...
def main() -> None:
    wind_df = pl.wind(return_type="pandas")
    ...
    wind_df["strength_label"] = wind_df["strength"]
    wind_df["strength"] = wind_df["strength"].apply(clean_strength).astype(float)

    print("\nCleaned wind strength values:")
    print(wind_df[["strength_label", "strength"]].drop_duplicates())
    ...
    fig = px.scatter(
        ...
        y="frequency",
        color="direction",
        hover_data=["direction", "strength_label", "frequency"],
        title="Wind Strength vs. Frequency by Direction",
        labels={
            "strength": "Wind Strength (cleaned numeric value)",
            "frequency": "Frequency",
